...
{
    [Serializable]
    public class IntegrationServiceRequest : Message
    {
        public const string k_RosMessageName = "ros_unity_integration/IntegrationService";
        public override string RosMessageName => k_RosMessageName;

        public Ur10eJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public IntegrationServiceRequest()
        {
            this.joints_input = new Ur10eJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public IntegrationServiceRequest(Ur10eJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        public static IntegrationServiceRequest Deserialize(MessageDeserializer deserializer) => new IntegrationServiceRequest(deserializer);

        private IntegrationServiceRequest(MessageDeserializer deserializer)
        {
            this.joints_input = Ur10eJointsMsg.Deserialize(deserializer);
