...
{
    [Serializable]
    public class IntegrationServiceResponse : Message
    {
        ...
        public IntegrationServiceResponse(Moveit.RobotTrajectoryMsg[] trajectories)
        {
            this.trajectories = trajectories;
        }

        public static IntegrationServiceResponse Deserialize(MessageDeserializer deserializer) => new IntegrationServiceResponse(deserializer);

        private IntegrationServiceResponse(MessageDeserializer deserializer)
        {
